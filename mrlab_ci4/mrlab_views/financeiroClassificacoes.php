...
?>
	...
	<div class="box-breadcrumb">
		<div class="row">
			<div class="col-12">
				<h2 class="page-title">Classificação</h2>
			</div>
		</div>
	</div>
								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div style="margin-left: 5px;"><a href="<?php echo(site_url('financeiro')); ?>" class="btn btn-sm btn-warning">Voltar</a></div>
											<div style="margin-left: 5px;"><a href="<?php echo(site_url('financeiroClassificacoes/form')); ?>" class="btn btn-sm btn-primary">Novo Registro</a></div>
										</div>
												...
												<table id="example2" class="display table table-striped table-bordered" style="width:100%">
													...
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															$count++;
															$finc_class_id = ($row->finc_class_id);
															$finc_class_hashkey = ($row->finc_class_hashkey);
															$finc_class_nome = ($row->finc_class_nome);
															$finc_class_func = ($row->finc_class_func);
															$finc_class_cliente = ($row->finc_class_cliente);
															$finc_class_modalidade = ($row->finc_class_modalidade);
						

															$link_form = site_url('financeiroClassificacoes/form/'. $finc_class_id);
															...
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		...
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdExcluirRegistro" data-hashkey ="<?php echo($finc_class_hashkey); ?>"><i class="las la-trash"></i></a>
																		</div>
																	</div>
																</td>
																<td><?php echo($finc_class_id); ?></td>
																<td><?php echo($finc_class_nome); ?></td>
																<td><?php echo (isset($finc_class_func) && $finc_class_func === "1") ? 'Sim' : 'Não'; ?></td>
																<td><?php echo (isset($finc_class_cliente) && $finc_class_cliente === "1") ? 'Sim' : 'Não'; ?></td>
																<td><?php echo($finc_class_modalidade); ?></td>															</tr>
														<?php
														}
													?>
													</tbody>

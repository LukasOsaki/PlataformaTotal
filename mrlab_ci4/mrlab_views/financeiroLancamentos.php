...
<div class="box-breadcrumb">
	<div class="row">
		<div class="col-12">
			<h2 class="page-title">Lançamentos Agendados</h2>
		</div>
	</div>
</div>
							...
							<div class="row align-items-center">
								...
								<div class="col-12 col-md-6">
									...
									<div class="d-flex justify-content-end">
										...
										<div style="margin-left: 5px;"><a href="<?php echo (site_url('financeiroLancamentos/form')); ?>" class="btn btn-sm btn-primary">Novo Registro</a></div>
									</div>
												...
												<table id="example2" class="display table table-striped table-bordered" style="width:100%">
													...
													<tbody>
														...
														foreach ($rs_list->getResult() as $row) {
															$count++;
															$finc_lanc_id = ($row->finc_lanc_id);
															$finc_lanc_hashkey = ($row->finc_lanc_hashkey);
															$finc_lanc_tipo = ($row->finc_lanc_tipo);


															$link_form = site_url('financeiroLancamentos/form/' . $finc_lanc_id);
															...
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		...
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdExcluirRegistro" data-hashkey="<?php echo ($finc_lanc_hashkey); ?>"><i class="las la-trash"></i></a>
																		</div>
																	</div>
																</td>
																<td><?php echo ($finc_lanc_id); ?></td>
																<td><?php echo ($finc_lanc_tipo); ?></td>

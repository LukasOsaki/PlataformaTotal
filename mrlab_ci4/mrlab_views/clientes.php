												...
												<table id="example2" class="display table table-striped table-bordered" style="width:100%">
													<thead>
														<tr>
															...
															<th>Título</th>
															<th style="width:90px;">Datas do Contrato</th>
														</tr>
													</thead>
													<tbody>
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															...
															$clie_dte_ini_contrato = ($row->clie_dte_ini_contrato);
															$clie_dte_end_contrato = ($row->clie_dte_end_contrato);
															...
															$link_form = site_url('clientes/form/'. $clie_id);
															...
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		...
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdExcluirRegistro" data-hashkey ="<?php echo($clie_hashkey); ?>"><i class="las la-trash"></i></a>
																		</div>
																	</div>
																</td>
																...
																<td class="text-center">
																	<div><?php echo($clie_dte_ini_contrato); ?></div>
																	<div><?php echo($clie_dte_end_contrato); ?></div>
																</td>
															</tr>
														<?php
														}

...
?>
	...
	<div class="box-breadcrumb">
		<div class="row">
			<div class="col-12">
				<h2 class="page-title">Tipos de Conta</h2>
			</div>
		</div>
	</div>
								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div style="margin-left: 5px;"><a href="<?php echo(site_url('financeiro')); ?>" class="btn btn-sm btn-warning">Voltar</a></div>
											<div style="margin-left: 5px;"><a href="<?php echo(site_url('financeiroTipos/form')); ?>" class="btn btn-sm btn-primary">Novo Registro</a></div>
										</div>
												...
												<table id="example2" class="display table table-striped table-bordered" style="width:100%">
													...
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															$count++;
															$finc_tipo_id = ($row->finc_tipo_id);
															$finc_tipo_hashkey = ($row->finc_tipo_hashkey);
															$finc_tipo_nome = ($row->finc_tipo_nome);
						

															$link_form = site_url('financeiroTipos/form/'. $finc_tipo_id);
															...
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		...
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdExcluirRegistro" data-hashkey ="<?php echo($finc_tipo_hashkey); ?>"><i class="las la-trash"></i></a>
																		</div>
																	</div>
																</td>
																<td><?php echo($finc_tipo_id); ?></td>
																<td><?php echo($finc_tipo_nome); ?></td>

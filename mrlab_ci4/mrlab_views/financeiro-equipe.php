...
<div class="box-breadcrumb">
	<div class="row">
		<div class="col-12">
			<h2 class="page-title">Financeiro Equipe</h2>
		</div>
	</div>
</div>
					...
					<div class="card card-default">
							...
							<div class="row align-items-center">
								...
								<div class="col-12 col-md-12">
									...
									<div class="d-flex justify-content-end">
										<div style="margin-left: 5px;"><a href="<?php echo (site_url('financeiro/formEquipe')); ?>" class="btn btn-sm btn-primary">Novo Registro</a></div>
										<div style="margin-left: 5px;"><a href="<?php echo (site_url('financeiro/exportar')); ?>" class="btn btn-sm btn-primary">Exportar</a></div>
										<div style="margin-left: 5px;">
											<a href="<?php echo site_url('financeiro/exportarEquipe') . '?' . http_build_query($_GET); ?>" class="btn btn-sm btn-primary">Exportar</a>
										</div>
									</div>
						...
						<div class="card-header-box">
							<div class="row align-items-center">
								<div class="col-12 col-md-12">
									<div class="d-flex justify-content-end">
										<form action="<?php echo site_url('financeiro/filtrarEquipe'); ?>" method="GET">
												...
												<table id="example2" class="display table table-striped table-bordered" style="width:100%">
													...
													<tbody>
														...
														foreach ($rs_list->getResult() as $row) {
															...
															$link_form = site_url('financeiro/formEquipe/' . $finc_id);

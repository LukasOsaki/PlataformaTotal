...
<div id="app">
	<div class="row align-items-start">
		...
		<?php if (!empty($validation)): ?>
			...
			<?php else : ?>
				<form action="<?= site_url('financeiro/salvar') ?>" method="post" id="formFinanceiro">
					<div class="row align-items-start">
						<div class="card card-default">
								...
								<div id="lancamentosContainer">
									...
									<div class="lancamento-item" data-index="0">
										...
										<div class="row" id="tpConta class perd">
											<div class="col-12 col-md-3">
												<div class="form-group">
													<label class="form-label" for="lancamento[0][finc_modaldiade]">Modalidade</label>
													<select
														name="lancamento[0][finc_modaldiade]" id="lancamento[0][finc_modaldiade]" class="form-control">
														<option value="">Selecione</option>

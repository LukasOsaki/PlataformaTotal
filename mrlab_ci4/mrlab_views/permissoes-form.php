								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(site_url('permissoes')); ?>" class="btn btn-sm btn-warning">Voltar</a></div>
								...
								<div class="row ">
									<div class="col-12 col-md-3">
										...
										<div class="row">
											<div class="col-12">
												<?php 
													$perm_ativo = (int)((isset($rs_dados->perm_ativo) ? $rs_dados->perm_ativo : "1")); 
													$ativo_s = ($perm_ativo == "1" ? ' checked ' : '');
													$ativo_n = ($perm_ativo != "1" ? ' checked ' : '');
												?>
													...
													<div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="perm_ativo" id="ativo_s" class="custom-control-input" value="1" <?php echo($ativo_s)?> />
																<label class="custom-control-label" for="ativo_s">Sim</label>
															</div>
														</div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="perm_ativo" id="ativo_n" class="custom-control-input" value="0" <?php echo($ativo_n)?> />
									...
									<div class="col-12 col-md-9">
										...
										<div class="row">
											<div class="col-12 col-md-12">
												<div class="form-group">
													<label class="form-label" for="perm_titulo">Título da Permissão</label>
													<input type="text" name="perm_titulo" id="perm_titulo" class="form-control" value="<?php echo((isset($rs_dados->perm_titulo) ? $rs_dados->perm_titulo : ""));?>" />
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-12 col-md-12">
												...
												<div class="table-box table-responsive">
													<table id="example2" class="mt-5 mb-5 display nowrap table table-striped table-bordered" style="width:100%">
														<thead>
															<tr>
																<th>Área</th>
																<?php
																	if( isset($list_sistema_acoes) ){
																		foreach ($list_sistema_acoes as $keyAcao => $valAcao) {
																		?>
																			<th class="text-center" style="width: 100px;"><?php echo($valAcao); ?></th>
																		<?php
																		}
																	}
																?>
														...
														<tbody>
														<?php
															//$clie_redes_sociais = (isset($rs_dados->clie_redes_sociais) ? $rs_dados->clie_redes_sociais : '');
															//$arr_redes_sociais = json_decode( $clie_redes_sociais, true);
															if( isset($list_sistema_areas) ){
																foreach ($list_sistema_areas as $key => $value) {
																?>
																<tr>
																...
																<?php
																	if( isset($list_sistema_acoes) ){
																		foreach ($list_sistema_acoes as $keyAcao => $valAcao) {
																?>
																	<td class="text-center"><input type="checkbox" value="1" name="permissaoAcao[<?php echo($key); ?>][<?php echo($keyAcao); ?>]" ></td>
																<?php
																		}
																	}
																?>

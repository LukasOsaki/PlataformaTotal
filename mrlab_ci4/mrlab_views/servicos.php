												...
												<table id="example2" class="display table table-striped table-bordered" style="width:100%">
													...
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															...
															$_pendtag_dte_registro = $row->pendtag_dte_registro;
															...
															$_pendtag_dte_instalacao = $row->pendtag_dte_instalacao;
															$pendtag_dte_instalacao = fct_formatdate($row->pendtag_dte_instalacao, 'd/m/Y');

															$link_form = site_url('servicos/form/'. $pend_id);
														...
														?>
															<tr class="trRow">
																...
																<td><?php echo($clie_nome_fantasia); ?></td>
																<td>
																	<span style="display:none"><?php echo($_pendtag_dte_registro); ?></span>
																	<div><?php echo($pendtag_dte_registro); ?></div>
																</td>
																<td>
																	<span style="display:none"><?php echo($_pendtag_dte_instalacao); ?></span>
																...
																<td style="background-color: <?php echo($categ_color); ?>">
																	...
																	<div><?php echo($pendtag_tag); ?></div>
																</td>
																<td><?php echo($pendtag_descricao); ?></td>
															</tr>
														<?php
														}
													?>

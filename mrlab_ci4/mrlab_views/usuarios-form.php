								...
								<div class="row ">
									...
									<div class="col-12 col-md-9">
										...
										<div class="row">
											<div class="col-12 col-md-12">
												<?php 
													$_perm_id = (isset($rs_dados->perm_id) ? $rs_dados->perm_id : "");
												?>
												<div class="form-group d-none">
													<label class="form-label" for="perm_id">Permissão</label>
													<select class="form-select" name="perm_id" id="perm_id">
														<option value="" translate="no">- selecione -</option>
														<?php
														if( isset($rs_list_permissoes)){
															foreach ($rs_list_permissoes->getResult() as $row) {
																$perm_id = ($row->perm_id);
																$perm_titulo = ($row->perm_titulo);
																$selected = (($perm_id == $_perm_id) ? "selected" : "");
														?>
															<option value="<?php echo($perm_id); ?>" <?php echo($selected); ?> translate="no"><?php echo($perm_titulo); ?></option>
														<?php
															}
														}
														?>

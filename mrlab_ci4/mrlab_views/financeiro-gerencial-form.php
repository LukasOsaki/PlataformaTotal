									...
									<div class="row align-items-center">
										...
										<div class="col-12 col-md-6">
											...
											<div class="d-flex justify-content-end">
												<div style="margin-left: 5px;"><a href="<?php echo (site_url('financeiro/gerencial')); ?>" class="btn btn-sm btn-warning">Voltar</a></div>
									...
									<div class="row" id="tp e nm">
										...
										<div class="col-12 col-md-3">
											<div class="form-group">
												...
												<input disabled type="number" name="finc_nr_parcela" id="finc_nr_parcela" class="form-control"
										...
										<div class="col-12 col-md-3">
											<div class="form-group">
												...
												<input disabled type="number" name="finc_nr_parcela_total" id="finc_nr_parcela_total" class="form-control"
...
<script>
	document.querySelector("form").addEventListener("submit", function() {
		...
		document.getElementById("finc_nome").removeAttribute("disabled");
	});

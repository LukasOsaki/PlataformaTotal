									...
									<div class="tab-content border" id="nav-tabContent" style="padding: 2rem 1rem; border-radius: 8px !important; border-top-left-radius: 0px !important;">
										<div class="tab-pane fade active show" id="nav-principal" role="tabpanel" aria-labelledby="nav-principal-tab">
											...
											<div class="row">
												<div class="col-12 col-md-12">
													<div class="form-group">
														<label class="form-label" for="clie_hashkey">Chave API</label>
														<input type="text" name="clie_hashkey" id="clie_hashkey" class="form-control" value="<?php echo ((isset($rs_dados->clie_hashkey) ? $rs_dados->clie_hashkey : "")); ?>" readonly="readonly" onfocus="this.blur();" />
													</div>
												</div>
											</div>
											<div class="row">

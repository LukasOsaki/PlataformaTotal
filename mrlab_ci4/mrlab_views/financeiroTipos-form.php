...
?>
	...
	<div class="box-breadcrumb">
		<div class="row">
			<div class="col-12">
				<h2 class="page-title">Tipo de Conta</h2>
			</div>
		</div>
	</div>
								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(site_url('financeiroTipos')); ?>" class="btn btn-sm btn-warning">Voltar</a></div>
								...
								<div class="row ">
									<div class="col-12 col-md-12">
										...
										<div class="row">
											<div class="col-12">
												<?php 
													$finc_tipo_ativo = (int)((isset($rs_dados->finc_tipo_ativo) ? $rs_dados->finc_tipo_ativo : "1")); 
													$ativo_s = ($finc_tipo_ativo == "1" ? ' checked ' : '');
													$ativo_n = ($finc_tipo_ativo != "1" ? ' checked ' : '');
												?>
													...
													<div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="finc_tipo_ativo" id="ativo_s" class="custom-control-input" value="1" <?php echo($ativo_s)?> />
																<label class="custom-control-label" for="ativo_s">Sim</label>
															</div>
														</div>
														<div class="form-check-inline my-1">
															<div class="custom-control custom-radio">
																<input type="radio" name="finc_tipo_ativo" id="ativo_n" class="custom-control-input" value="0" <?php echo($ativo_n)?> />
									...
									<div class="col-12 col-md-12">
										...
										<div class="row">
											<div class="col-12 col-md-12">
												<div class="form-group">
													<label class="form-label" for="finc_tipo_nome">Nome</label>
													<input type="text" name="finc_tipo_nome" id="finc_tipo_nome" class="form-control" value="<?php echo((isset($rs_dados->finc_tipo_nome) ? $rs_dados->finc_tipo_nome : ""));?>" />
												</div>
											</div>
										</div>

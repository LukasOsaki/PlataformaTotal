															...
															<div class="row gx-2 align-items-end">
																...
																<div class="col-12 col-md-3">
																	<div class="form-group d-flex">
																		<input type="text" name="arq_anexo_<?php echo( $arq_hash_item ); ?>" id="arq_anexo_<?php echo( $arq_hash_item ); ?>" class="form-control form-control-sm inputfile inputfile-1" data-multiple-caption="{count} files selected" />
																		<label for="arq_anexo_<?php echo( $arq_hash_item ); ?>" style="cursor: default !important;"><span><?php echo( $label_anexo ); ?></span></label>

												...
												<table id="example2" class="display nowrap table table-striped table-bordered" style="width:100%">
													...
													<?php
														...
														foreach ($rs_list->getResult() as $row) {
															$count++;
															$ped_id = ($row->ped_id);
															$ped_hashkey = ($row->ped_hashkey);
															$cad_nome = ($row->cad_nome);
															$cad_email = ($row->cad_email);
															$ped_envio_tipo = ($row->ped_envio_tipo);
															$ped_pagto_tipo = ($row->ped_pagto_tipo);
															$cad_email = ($row->cad_email);
															...
															$link_form = site_url('pedidos/form/'. $ped_id);
														?>
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		...
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdExcluirRegistro" data-hashkey ="<?php echo($ped_hashkey); ?>"><i class="las la-trash"></i></a>
																		</div>
																	</div>
																</td>
																<td><?php echo($ped_id); ?></td>
																<td>
																	<div><?php echo($cad_nome); ?></div>
																	<div><?php echo($cad_email); ?></div>
																</td>
																<td>
																	<div><?php echo($label_envio); ?></div>
																</td>
																<td>
																	<div><?php echo($label_pagto); ?></div>
																</td>
															</tr>
														<?php
														}

								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6">
										...
										<div class="d-flex justify-content-end">
											<div style="margin-left: 5px;"><a href="<?php echo(site_url('produtos/form')); ?>" class="btn btn-sm btn-primary">Novo Registro</a></div>
										</div>
															...
															<tr class="trRow">
																<td class="text-center">
																	<div class="d-flex justify-content-center">
																		...
																		<div style="margin: 0 3px;">
																			<a href="javascript:;" class="btn btn-sm btn-ac btn-danger cmdExcluirRegistro" data-hashkey ="<?php echo($prod_hashkey); ?>"><i class="las la-trash"></i></a>
																		</div>
																	</div>
																</td>
																<td><?php echo($prod_id); ?></td>
																<td>
																	<div><?php echo($prod_titulo); ?></div>
																</td>
																<td>
																	<div><?php echo($prod_valor); ?></div>
																</td>
																<td>

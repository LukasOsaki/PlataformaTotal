...
$(document).ready(function ($) {
	...
	// Antes de submeter o formulário, formata o valor
	$('form').on('submit', function () {
		$('.mask-money').each(function () {
			const val = $(this).val();
			// Remove pontos e troca vírgula por ponto
			$(this).val(val.replace(/\./g, '').replace(',', '.'));
		});
	});
	...
	$(".mask-phone-fixo").mask('0000-0000', { placeholder: "____-____", clearIfNotMatch: true });
	$(".mask-phone-cel").mask('00000-0000', { placeholder: "_____-____", clearIfNotMatch: true });

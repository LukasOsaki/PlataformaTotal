var gcObject = {
  ...
  eventAnimate: "none",
  pickedDate: new Date(),
  newEvents: [{ date: null, eventName: null, className: null, onclick: function (ev, data) {}, dateColor: "#38385c" }],
  setDate(date) {
  ...
  setNewEvents(pEvents) {
	console.log( pEvents );
	this.newEvents = pEvents;
	//this.render();
  },
  prevMonth() {
